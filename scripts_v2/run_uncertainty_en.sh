#!/usr/bin/env bash
# Round-2 pilot — GossipCop (en). Epistemic/aleatoric decoupling go/kill test.
# Reuses v1 checkpoint outputs/ckpt/gossipcop_roberta/best.pt; writes only outputs_v2/.
...
echo "[run_en] done -> outputs_v2/diagnostic/${NAME}/uncertainty_bands.json"
